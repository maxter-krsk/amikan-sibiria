...
export default function DevelopedBy() {
  return (
    ...
    >
      <Link
        className="relative uppercase tracking-wide group font-medium text-sm inline-flex items-center gap-2"
      ...
      >
        ...
        >
          ...
          <span className="relative inline-block">
            ...
            <motion.span
              className="absolute bottom-0 left-0 w-0 h-px bg-[#BC9C5F]"
              variants={{
