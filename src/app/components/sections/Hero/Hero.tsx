...
export default function Hero() {
  ...
  return (
    <section
      className={`${bg.heroBg} mx-0 desk:mt-20 desk:mx-20 mb-100 md:mb-120 desk:mb-150 relative min-h-screen`}
      aria-labelledby="hero-title"
    >
      <div className="container mx-auto flex flex-col items-center md:items-start justify-center min-h-screen">
