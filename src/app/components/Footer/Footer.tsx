...
export default function Footer() {
  return (
    <footer className="bg-darkGreen pt-20 pb-50 md:pt-30 md:pb-70">
      <div className="container">
        <Link href="/">
          <Image
            ...
            width={126}
            height={126}
            className="mb-30 desk:mb-50 w-[4.87rem] h-[4.87rem] md:w-[6.75rem] md:h-[6.75rem] desk:w-[7.87rem] desk:h-[7.87rem]"
          />
        </Link>
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-30 md:gap-50 desk:gap-0 auto-rows-auto">
